...
- **Attribute-like names** – nouns such as "manufacturer", "make", "model", "price class", "rental price", "rental charge", "depreciation", "theme", "slogan", "duration", "contact information", "website", "service charges", "payments received", "account balances", "fee", "size", "price", "evaluation", "status", "keynote address", "type", "grace period", "means", "void", "opened", "balance", "charges", "payment", "conference room" are attributes, not classes.  
