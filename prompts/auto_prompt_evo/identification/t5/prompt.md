...
- When the text lists items like "purchase, repair, maintenance, disposal" as things the business tracks about vehicles, put them under rule 1, not rule 4.
...
- DO capture abstract nouns like "evaluation", "review", "current loan", "payments received", "organization staff", "committee", "status", "fee", "advertisement", "membership", "details", "options", "rentals" under rule 1.
- DO capture "shows" / "show", "visit", "cover", "sent to", "checked out", "denoted", "stamped", "scanned", "searched", "identified", "reserved", "renewed", "issued", "prepared", "attended", "invited", "selected", "requested", "rented", "distributed", "exhibited", "kept", "entered", "returned to", "taken from", "pay", "give", "prepares" as rule 3 verbs when they appear in the text.
...
- For rule 2, capture "number of subject sections", "makes of car", "model of car", "update of records", "status of a proposal", "committee of reviewers", "depreciation of the rental cars" etc. exactly as they appear.
...
- DO NOT generate rule 3 entries for verbs that do not appear in the text (e.g., do not invent "keep track of" if the text says "keep"; do not invent "group into" if the text does not use that phrase).
- DO NOT generate rule 1 entries for nouns that do not appear in the text.
- DO NOT generate rule 4 entries for items that are tracked as domain entities (purchase, repair, maintenance, disposal go under rule 1).
- For rule 4, "invited and/or selected" should be listed as separate values "invited" and "selected" unless the text treats them as a single combined state.
